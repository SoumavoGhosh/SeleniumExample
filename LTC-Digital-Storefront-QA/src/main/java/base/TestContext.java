...
public class TestContext {
	...
	/*public boolean checkHeaderLogo(String pageName, String expected_page_title) {
		...
		case Constants.HOME_LTC:
			...
			return interaction.isElementVisible(homePage.header_item_logo);

		case Constants.HOME_LTC_OLD:
			log.info("Logo for LTC_Old_Customer_Portal_Home is visible.");
			return interaction.isElementVisible(homePage.header_item_logo);
	...
	public boolean verifyLoggedInUsername(String pageName, String userFullName) {
		...
		case Constants.HOME_LTC_OLD:
			usernameObject = homePage.old_header_item_fullname;
			break;
		}
