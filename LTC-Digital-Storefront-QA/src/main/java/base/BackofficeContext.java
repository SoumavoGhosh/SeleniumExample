...
public class BackofficeContext extends TestContext {
	...
	private boolean login_to_sfdc_backoffice_as_system_admin() {
		String urlLink = TestUtility.getValueFromSettings("SFDC_BACKOFFICE_LOGIN_URL");
		String sfdc_username = TestUtility.getValueFromSettings("SFDC_BACKOFFICE_LOGIN_SYS_ADMIN_USERNAME");
		String sfdc_password = TestUtility.getValueFromSettings("SFDC_BACKOFFICE_LOGIN_SYS_ADMIN_PASSWORD");
	...
	public boolean search_text_in_sfdc_backoffice(String user_full_name) {
